    ...
    <div>
      <div className="relative my-5">
        <div className="absolute inset-0 flex items-center">
          <div className="w-full border-t border-[#cccacc]" />
        </div>
        <div className="relative flex justify-center">
          <span className="bg-white px-3 text-xs text-[#9b9b9b] uppercase tracking-wide">
            or continue with
          </span>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 gap-3">
        <a
          ...
          className="flex items-center justify-center gap-2 border border-[#cccacc] px-4 py-2.5 text-sm font-medium text-[#1a1a1a] hover:bg-[#f9f5f2] transition-colors"
        >
          <GoogleIcon />
          Google
        </a>
